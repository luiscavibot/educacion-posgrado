...
export const Inversion = () => {
	...
	const handleClick = (event, { activeIndex }) => {
		switch (activeIndex) {
			case 0:
				router.push(
					'/formacion-academica/admision?nivel=posgrado&tab=inversion&programa=maestria',
					undefined,
					{
						shallow: true,
					}
				...
				<Tab.Pane attached={false}>
					<div className="overflow-x-auto mt-3">
						<p className="text-negro font-bold mb-4">
							Paga tu derecho de inscripción de forma fácil y
							segura en los siguientes nuestros medios
							autorizados:
						</p>
						<div className="mb-4">
							...
							<p className="mb-8">
								A continuación detallamos el número de Cuenta
						...
						<div className="flex flex-wrap justify-center mb-14">
							...
							<div className="mb-6 md:mb-0 pt-6 w-[289px] mx-4 card flex flex-col px-6 py-8">
								...
								<p>
									<span className="font-bold">Para</span>:
									Postulantes graduados de otras
									universidades.
								</p>
							</div>
						</div>
						...
						<div className="mb-8">
							...
							<p className="mb-8">
								Acércate presencialmente a una de sus agencias
								más cercanas e indica que realizarás un depósito
								al n.° de TRANSACCIÓN 9650 + el código que
								corresponda; así como el n.° DNI, carné de
