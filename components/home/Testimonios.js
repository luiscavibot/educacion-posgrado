			...
			>
				...
				<div className="col-start-2 col-span-10">
					<div className="relative">
						...
						<div className="static md:absolute md:w-1/2 md:left-1/2 md:top-1/2 md:-translate-y-1/2">
							<div className="relative">
								<div className="bg-complementaryTwo px-6 md:pl-[32%] py-8 md:pr-11 rounded-lg">
