...
const Index = ({ ultimasNoticias }) => {
	...
	const tramite = {
		id: '',
		titulo: 'Protocolo de trámite para la obtención del título de Segunda Especialidad',
		descripcion:
			'Guía de pasos con todo el proceso y requisitos para la obtención del título de Segunda Especialidad.',
		dirigido: 'Posgrado, egresados',
		fecha: '',
						...
						<div className="mb-8">
							...
							<div className="html-default-tramite space-y-4">
								<p>
									...
									necesitas para obtener el título de Segunda
									Especialidad sin complicaciones.
								</p>
								<div>
									<button
										onClick={() =>
										...
										<div className="flex space-x-2">
											...
											<p className="!mb-0">
												Paso 1: Inscripción del trabajo
												académico y nombramiento de
								...
								<div>
									<button
										...
										<div className="flex space-x-2">
											...
											<p className="!mb-0">
												Paso 2: Fecha de sustentación
												para segundas especialidades
											</p>
										</div>
										<div
											className={`transition-transform duration-500 ${
								...
								<div>
									<button
										...
										<div className="flex space-x-2">
											...
											<p className="!mb-0">
												Paso 3: Emisión de expediente a
												Decanato para segunda
												especialidad
											</p>
										</div>
										<div
