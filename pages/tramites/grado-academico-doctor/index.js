...
const Index = ({ ultimasNoticias }) => {
	...
	const tramite = {
		id: '',
		titulo: 'Protocolo de trámite para la obtención del grado académico de doctor',
		descripcion:
			'Guía de pasos con todo el proceso y requisitos para la obtención del grado de doctor',
